...
<head>
  ...
  <title><?php echo $company ?> | Registration Page</title>
...
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    <?php echo validation_errors('<span class="error">', '</span>'); ?>
      ...
      <div class="form-group has-feedback">
          <input type="text" class="form-control" placeholder="Address" name="address" value="" required autofocus>
          <span class="glyphicon glyphicon-home form-control-feedback"></span>
          <?php echo form_error('address', '<span class="help-block">', '<span>'); ?>
      </div>
      <div class="form-group has-feedback">
          <input type="text" class="form-control" placeholder="Phone" name="telp" value="" required autofocus>
      ...
      <div class="form-group has-feedback">
          <input type="password" class="form-control" placeholder="Retype password" name="password-confirmation" required>
